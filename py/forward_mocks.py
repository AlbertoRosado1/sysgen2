...
# generate the WEIGHT_SN weights in the catalogs. It uses all 25 models on 1 mock.
# example to run 
# python forward_mocks.py --mockid 10 --type LRG --survey_version v0.6 --nran 15
...
prep_mockdir = outdir+f"/mock{mockid}/sysnet"
